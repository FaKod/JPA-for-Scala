...
<filter>
  ...
  <query id="fetchFilter" alias="c" annotation="myAnno1 myAnno2">
	<FilterClass class="test.testfilter.MyTestFilter"/>
...
Since the query can return more than one result _forQueryResults_ can be used to iterate over the results.
